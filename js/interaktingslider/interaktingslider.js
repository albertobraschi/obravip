...
//Set if will show Counters or not
InteraktingSlider.prototype.setShowCounters = function(show){
	this.showCounters= show;
}

// Set if will show numbers or not
InteraktingSlider.prototype.setShowNumbers = function(show){
