...
<div style="display: none;" class="container_12" id="profile_action">
<div style="display: none;" class="grid_12 subtitle"><span>Configure Current Profile (<?php echo $profilename?>)</span>
<?php 
...
<div style="display: none;" class="grid_12 col">
...
<form  action="" method="POST" id="saveprofile_form">
	...
	<div class="grid_12 col <?php if($k==$order[count($order)-1]){?>omega<?php }?>">
		...
		{?>
			<?php $pinf=$plugins[$k];?>
			<?php if(count($pinf)>0){?>
			<div style="display: none;" class="pluginselect" style="float:left">
			...
			foreach($pcats as $pcat=>$pclasslist) {?>
				...
				<?php foreach($pinf as $pclass)	{
					...
					{?>
						...
						<div style="display: none;" class="grid_12 omega"><h1><?php echo $pcat?></h1>
						<?php }?>
						<ul>
						<?php
							$pinst=Magmi_PluginHelper::getInstance($profile)->createInstance($k,$pclass);
...
<div style="dsplay: none;" class="grid_12">
<div style="dsplay: none;"  style="float:right">
		<a style="dsplay: none;" id="saveprofile" class="actionbutton" href="javascript:void(0)" <?php if(!$conf_ok){?>disabled="disabled"<?php }?>>Salva configurações (<?php echo ($profilename=="Default") ? "Padrão" : $profilename;?>)</a> 
</div>
</div>
</div>

<div style="display: none;" id="paramchanged" style="display:none">
