...
<div class="container_12">
	<div class="grid_12 title ">
		...
		<div style="display: none;" class="info" style="width:400px">
		...
		<div style="display: none;" class="info" style="float:right;width:180px">
		<h3>Support Magmi!!</h3>
 			<div class="donate">If Magmi saves you countless hours or simply if you like it , you can <br/> <a href="http://sourceforge.net/donate/index.php?group_id=350817" target="_blank">donate to support development !</a></div>
		</div>
 	</div>
</div>
