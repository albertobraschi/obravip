<div style="display: none;" class="plugin_description">
...
<div class="csvmode">
 ...
 <ul style="display: none;" class="formline">
...
<br />
<a href="upload_csv.php">Upload do arquivo CSV</a>
<br />
<br />
 <ul class="formline">
 <li class="label">Diretório base de CSVs</li>
 <li class="value">
 <input readonly="readonly" type="text" name="CSV:basedir" id="CSV:basedir" value="/wwwroot/dev.obravip.com/var/import"></input>
 <!-- <input type="text" name="CSV:basedir" id="CSV:basedir" value="<?php echo $this->getParam("CSV:basedir","var/import")?>"></input>  -->
 <div class="fieldinfo">Caminho relativo ao diretorio de instalação do magento. Somente caminhos absolutos.</div></li>
 </ul>
 <ul class="formline">
 <li class="label" >Arquivo para importar:</li>
