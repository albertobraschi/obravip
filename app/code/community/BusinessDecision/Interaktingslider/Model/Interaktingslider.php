...
Class BusinessDecision_Interaktingslider_Model_Interaktingslider {
    ...
    public function getWidth(){
    	return Mage::getStoreConfig('interaktingslider/style/width');
    }
    ...
    public function getHeight(){
    	return Mage::getStoreConfig('interaktingslider/style/height');
    }
     ...
     * @return unknown
     */
    public function getShowCounters(){
    	$showcounters = Mage::getStoreConfig('interaktingslider/style/showcounters');
    	return $showcounters ? true : false;
    }
    ...
    public function getShowNumbers(){
    	$shownumbers = Mage::getStoreConfig('interaktingslider/style/shownumbers');
    	return $shownumbers ? true : false;
    }
