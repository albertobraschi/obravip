...
class VladimirPopov_WebForms_Block_Adminhtml_Webforms_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
	...
	public function getDuplicateUrl() {
		return $this->getUrl('*/adminhtml_webforms/duplicate', array ('id' => Mage::registry('webforms_data')->getId()));
	}
