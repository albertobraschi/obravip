 ...
 *
 * @category   Indexa
 * @package    Indexa_ProductAlert
 * @author     <gabriel@indexainternet.com.br>
 */
class Indexa_ProductAlert_Model_Observer extends Mage_ProductAlert_Model_Observer
{
     /**
...
//                $wholeCollection->getSelect()->order('alert_stock_id DESC');
     ...
     *
     * @return Indexa_ProductAlert_Model_Observer
     */
