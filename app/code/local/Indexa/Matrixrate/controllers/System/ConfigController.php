 ...
 */
class Indexa_Matrixrate_System_ConfigController extends Mage_Adminhtml_Controller_Action
{
...
/**
    ...
    public function exportmatrixAction()
    {
        ...
        $gridBlock  = $this->getLayout()->createBlock('indexa_matrixrate/adminhtml_shipping_carrier_matrixrate_grid');
