...
class Indexa_Matrixrate_Block_Adminhtml_Shipping_Carrier_Matrixrate_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  /**
    ...
    protected function _prepareColumns()
    {
        $this->addColumn('dest_country', array(
        	...
        	'renderer'  => 'Indexa_Matrixrate_Block_Adminhtml_Renderer_Render'
        ));
        ...
        $this->addColumn('estimated_delivery_time', array(
        		'header'    => Mage::helper('adminhtml')->__('Estimated Delivery Time'),
        		'index'     => 'estimated_delivery_time'
        ));
