...
class Indexa_Installments_Model_Advance extends Indexa_Installments_Model_Abstract {
     ...
     * Indexa_Installments_Block_Adminhtml_Installments_System_Config_Form_Field_Addinstallmentrange
     * class
     */

    public function getRangeFinalCode() {
        return Indexa_Installments_Block_Adminhtml_Installments_System_Config_Form_Field_Addinstallmentrange::RANGE_FINAL;
    }

    public function getNumeroDeParcelasCode() {
        return Indexa_Installments_Block_Adminhtml_Installments_System_Config_Form_Field_Addinstallmentrange::NUMERO_PARCELAS;
    }

    public function getCondicaoMaiorCode() {
        return Indexa_Installments_Block_Adminhtml_Installments_System_Config_Form_Field_Addinstallmentrange::CONDICAO_MAIOR;
    }

    public function getCondicaoMenorCode() {
        return Indexa_Installments_Block_Adminhtml_Installments_System_Config_Form_Field_Addinstallmentrange::CONDICAO_MENOR;
    }

    public function getRangeInicialCode() {
        return Indexa_Installments_Block_Adminhtml_Installments_System_Config_Form_Field_Addinstallmentrange::RANGE_INICIAL;
    }
