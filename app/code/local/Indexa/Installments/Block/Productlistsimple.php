...
class Indexa_Installments_Block_Productlistsimple extends Indexa_Installments_Block_Abstract
{
	public function _construct()
	{
		$this->setTemplate('indexa_installments/productlistsimple.phtml');
	}
