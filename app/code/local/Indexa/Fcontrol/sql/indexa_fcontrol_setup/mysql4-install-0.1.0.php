...
$installer->run('
    CREATE TABLE IF NOT EXISTS `indexa_fcontrol_orders` (
      ...
      CONSTRAINT `FK_ANTIFRAUD_ORDER_ID_SALES_FLAT_ORDER_ENTITY_ID` FOREIGN KEY (`order_id`) REFERENCES `sales_flat_order` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
');

$installer->run('
    CREATE TABLE IF NOT EXISTS `indexa_robots_logs` (
      `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
